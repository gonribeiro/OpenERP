...
export default function Inactives() {
  ...
  useEffect(() => {
    ...
    openErpApi.get(`employees/inactives`).then(response => {
  ...
  function CustomToolbar() {
    return (
      <GridToolbarContainer>
        <Button variant="text" size='small' component={RouterLink} to='/employees/create'>
  ...
  const columns: GridColDef<(typeof rows)[number]>[] = [
    ...
    { field: 'inactiveDate', headerName: 'Inactive Date', minWidth: 200, flex: 1, },
