...
export default function index() {
  ...
  useEffect(() => {
    openErpApi.get(`companies/`).then((response) => {
  ...
  const columns: GridColDef<(typeof rows)[number]>[] = [
    ...
    { field: 'legalName', headerName: 'Legal Name', minWidth: 200, flex: 1, },
    { field: 'tradeName', headerName: 'Trade Name', minWidth: 200, flex: 1, },
    { field: 'type', headerName: 'Type', minWidth: 100, flex: 1, },
    { field: 'contacts', headerName: 'Contacts', minWidth: 200, flex: 1, },
